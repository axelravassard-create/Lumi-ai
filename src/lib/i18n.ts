...
const fr: Dict = {
  ...
  'reveal.title': '✨ Moi, c’est Luminator.',
  ...
  'reveal.unlock': 'Débloquer Luminator',
  ...
  'hero.subtitle': 'Entrez votre profession. Lumi estime votre risque de remplacement par l’IA, sa progression jusqu’en 2040, et vous donne un plan concret pour garder une longueur d’avance.',
  ...
  'promo.pill': '✨ L’offre Luminator',
  'promo.h2a': 'L’analyse te montre le risque.',
  'promo.h2b': 'Luminator t’aide à agir — toute l’année.',
  ...
  'promo.cta': 'Découvrir Luminator',
  'promo.note': 'Essaie l’analyse gratuitement, passe à l’action avec Luminator.',
  ...
  'how.s2t': 'Lumi évalue l’exposition',
  'how.s2d': 'Lumi croise 7 facteurs : routine, créativité, relationnel, jugement…',
...
const en: Dict = {
  ...
  'hero.subtitle': 'Enter your profession. Lumi estimates your risk of being replaced by AI, how it grows through 2040, and gives you a concrete plan to stay ahead.',
  ...
  'promo.pill': '✨ The Luminator plan',
  'promo.h2a': 'The analysis shows you the risk.',
  'promo.h2b': 'Luminator helps you act — all year long.',
  ...
  'promo.cta': 'Discover Luminator',
  'promo.note': 'Try the analysis for free, take action with Luminator.',
  'how.title': 'In 3 steps',
  'how.s1t': 'Describe your job',
  'how.s1d': 'Just type your profession, the way you’d name it.',
  'how.s2t': 'Lumi assesses exposure',
  'how.s2d': 'Lumi weighs 7 factors: routine, creativity, relationships, judgment…',
...
const de: Dict = {
  ...
  'reveal.title': '✨ Ich bin Luminator.',
  ...
  'reveal.unlock': 'Luminator freischalten',
  'reveal.later': 'Später',
  ...
  'hero.subtitle': 'Gib deinen Beruf ein. Lumi schätzt dein Risiko, von KI ersetzt zu werden, dessen Entwicklung bis 2040 und gibt dir einen konkreten Plan, um vorne zu bleiben.',
  ...
  'promo.pill': '✨ Das Luminator-Angebot',
  'promo.h2a': 'Die Analyse zeigt dir das Risiko.',
  'promo.h2b': 'Luminator hilft dir zu handeln — das ganze Jahr.',
  ...
  'promo.cta': 'Luminator entdecken',
  'promo.note': 'Teste die Analyse kostenlos, werde mit Luminator aktiv.',
  'how.title': 'In 3 Schritten',
  'how.s1t': 'Beschreibe deinen Beruf',
  'how.s1d': 'Gib einfach deinen Beruf ein, so wie du ihn nennen würdest.',
  'how.s2t': 'Lumi bewertet das Risiko',
  'how.s2d': 'Lumi berücksichtigt 7 Faktoren: Routine, Kreativität, Beziehung, Urteilsvermögen…',
...
const es: Dict = {
  ...
  'reveal.unlock': 'Desbloquear Luminator',
  ...
  'hero.subtitle': 'Introduce tu profesión. Lumi estima tu riesgo de ser reemplazado por la IA, su evolución hasta 2040 y te da un plan concreto para ir un paso por delante.',
  ...
  'promo.pill': '✨ El plan Luminator',
  'promo.h2a': 'El análisis te muestra el riesgo.',
  'promo.h2b': 'Luminator te ayuda a actuar, todo el año.',
  ...
  'promo.cta': 'Descubrir Luminator',
  'promo.note': 'Prueba el análisis gratis, pasa a la acción con Luminator.',
  'how.title': 'En 3 pasos',
  'how.s1t': 'Describe tu profesión',
  'how.s1d': 'Solo escribe tu profesión, tal como la llamarías.',
  'how.s2t': 'Lumi evalúa la exposición',
  'how.s2d': 'Lumi cruza 7 factores: rutina, creatividad, relación, criterio…',
...
const zh: Dict = {
  ...
  'reveal.title': '✨ 我是 Luminator。',
  'reveal.desc': '我帮你自动化职业中重复的任务——AI 工具、无代码、即用模板，贴合你的技能。',
  'reveal.unlock': '解锁 Luminator',
  'reveal.later': '以后再说',
  'ai.poweredClaude': '由 Claude 提供分析',
  'ai.poweredAI': '由 AI 提供分析',
  'hero.h1a': '你的职业能否挺过',
  'hero.h1b': '人工智能的冲击？',
  'hero.subtitle': '输入你的职业。Lumi 估算你被 AI 取代的风险、到 2040 年的变化趋势，并给你一份保持领先的具体计划。',
  'mode.single': '🎯 分析一个职业',
  ...
  'promo.pill': '✨ Luminator 套餐',
  'promo.h2a': '分析让你看清风险。',
  'promo.h2b': 'Luminator 全年帮你行动。',
  'promo.desc': '你的 AI 副驾驶，自动化你职业中的任务，为你节省时间并长期陪伴。不只是一个分数。',
  'promo.b1': '⚡ 自动化重复任务',
  'promo.b2': '🧠 针对你职业的建议',
  'promo.b3': '🛠️ 即用的 AI / 无代码工具',
  'promo.b4': '📈 持续陪伴，而非一次性',
  'promo.cta': '了解 Luminator',
  'promo.note': '免费试用分析，用 Luminator 付诸行动。',
  'how.title': '三个步骤',
  'how.s1t': '描述你的职业',
  'how.s1d': '直接输入你的职业名称即可。',
  'how.s2t': 'Lumi 评估风险',
  'how.s2d': 'Lumi 综合 7 个因素：重复性、创造力、人际、判断力……',
  'how.s3t': '获取你的计划',
